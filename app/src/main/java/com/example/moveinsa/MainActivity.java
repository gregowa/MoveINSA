...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        partenaireBDD.insertPartenaire(new Partenaire("Universidad de Buenos Aires", "Buenos Aires", "Argentine"));
        partenaireBDD.insertPartenaire(new Partenaire("École de Technologie Supérieure", "Montréal", "Canada"));
        partenaireBDD.insertPartenaire(new Partenaire("Gwangju Institute of Science and Technology", "Gwangju", "Corée du Sud"));
        partenaireBDD.insertPartenaire(new Partenaire("Universidad de Granada", "Granada", "Espagne"));
        partenaireBDD.insertPartenaire(new Partenaire("Illinois Institute of Technology", "Chicago", "USA"));
        partenaireBDD.insertPartenaire(new Partenaire("Politecnico di Milano", "Milano", "Italie"));

        offreBDD.insertOffre(new Offre(1, "ER", "MIQ", 6, 30));
        offreBDD.insertOffre(new Offre(1, "HR", "GM", 7, 50));
        offreBDD.insertOffre(new Offre(2, "ER", "PL", 8, 10));
